...
c.InteractiveShellApp.exec_lines = [
    ...
    "from scipy import optimize, interpolate, integrate, io",
    "%autoreload 2",
]
...
# c.InteractiveShell.banner1 = "Python 3.6.9 (default, Oct  8 2020, 12:12:24) \nType 'copyright', 'credits' or 'license' for more information\nIPython 7.16.1 -- An enhanced Interactive Python. Type '?' for help.\n"
...
c.AliasManager.user_aliases = [("clc", "clear")]
